...
class CFGNode(object):
    ...
    """
    def __init__(self, type, compound = None, index = 0):
        self._type = type
        self._start_line = 0
        self._last_line = 0
        ...
        self._children = []
        self._ast_elem_list = []
#CHANGED. Added these fields to indicate where in a list of AST statements a node belongs.
    ...
    def add_ast_elem(self, ast_elem, compound = None, index = 0):
...
#CHANGED.  Added self.compound and self.index assignment.
	self.compound = compound
	self.index = index

#CHANGED. Added this method. Looks through a compound statement list for the right index,
#inserts the boundary statement there.
    def add_boundary(self):
	i = 0
        j = 0
	while not j is self.index:
	    if not isinstance(self.compound.block_items[i], c_ast.Boundary):
                j = j + 1
            i = i + 1
        self.compound.block_items.insert(i, c_ast.Boundary())

#CHANGED. Added these four setters and getters.
    def set_visit_number(self, num):
	self.visit_number = num

    def get_visit_number(self):
	return self.visit_number

    def set_place_boundary(self, num):
	self.place_boundary = num

    def get_place_boundary(self):
	return self.place_boundary
